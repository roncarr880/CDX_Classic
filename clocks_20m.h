/*********
 * Clock 0 is vfo, clock 1 is bfo, clock 2 is transmit 
 * Original idea was to use clocks 1 and 2 to drive push pull TX, changed to just clock 2 used for TX
 * 
...
//  something in the commented data prevents the si5351 from working
